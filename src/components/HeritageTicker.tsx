...
export const HeritageTicker = () => {
  ...
  return (
    <div className="bg-heritage-sand text-heritage-charcoal py-4 overflow-hidden border-y border-heritage-charcoal/5 relative z-30">
      <div className="flex">
